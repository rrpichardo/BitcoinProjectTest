...
The current repo ships the primary Evidently comparison at `reports/evidently/train_vs_test.html`. The handoff package includes the same artifact as `handoff/reports/train_vs_test.html`.
